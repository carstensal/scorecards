...
knitr::include_graphics("/www/binning-woe.png", error = FALSE)
```
...
knitr::include_graphics("/www/binning-iv.png", error = FALSE)
```
...
knitr::include_graphics("/www/binning-numeric.png", error = FALSE)
```

```{r, echo=FALSE, fig.cap="Binning Character", out.width="80%"}
knitr::include_graphics("/www/binning-character.png", error = FALSE)
```